...
public sealed class ExcelDataAttribute(string filePath) : DataAttribute
{
    ...
    public override ValueTask<IReadOnlyCollection<ITheoryDataRow>> GetData(MethodInfo testMethod, DisposalTracker disposalTracker)
    {
        ...
        var resultRows = new List<ITheoryDataRow>();
        ...
        for (var rowNum = 2; rowNum <= ws.Dimension.End.Row; rowNum++)
        {
            ...
            resultRows.Add(new TheoryDataRow([.. objArr]));
        }

        return ValueTask.FromResult<IReadOnlyCollection<ITheoryDataRow>>(resultRows);
    }
